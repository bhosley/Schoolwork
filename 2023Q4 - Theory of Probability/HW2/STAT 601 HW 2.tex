...
\begin{questions}
	...
	\question Let $X$ have the pdf $$ f(x) = \frac{4}{\beta^3\sqrt{\pi} x^2 e^{-x/\beta^2}}, 0 < x < \infty, \beta > 0.$$
	\begin{parts}
		\part Verify that $f(x)$ is a pdf.
	...
	\question  In each of the following cases verify the expression given for the moment generating funciton, and in each case use the mgf to calculate $E(X)$ and $Var(X)$.
	\begin{parts}
