...
\begin{solution}
	\begin{enumerate}
		\item Start at initial node, node 1, mark visited.
		\subitem Update weights of node 2: \(2<\infty\), and node 3: \(8<\infty\).
		\subitem Advance to the lower of the two, node 2.
		
		\item Mark node 2 as visited.
		\subitem Update destination weights, node 3:\(7<8\), node 4\(5<\infty\).
		\subitem Advance to the lower weight, node 4.
		
		\item  Mark node 4 as visited.
		\subitem Update destination weights
	\end{enumerate}
\end{solution}
