...
\begin{flalign*}
	\text{Max  } z=9x_1 +7x_2 +0s_1 +0s_2 -MA_1 & &\\
	\text{s.t.}\hspace{2.5em} 2x_1 + 1 x_2 +s_1 \hspace{6.5em} &\leq 10 &\\
	4x_1 + 5 x_2 \hspace{2.25em} +s_2 \hspace{4.25em}&\leq 40 &\\
	x_1 \hspace{7em}-s_3 + A_1 &\geq 2 &\\
...
\end{flalign*}
\begin{flalign*}
	\text{Max }z = 2x_1 -x_2 +5x_3 +0s_1 +0s_2 +0s_3 & & \\
	\text{s.t. }\hspace{2em} 3x_1 \hspace{2.5em} -2x_3 +s_1 \hspace{5.5em} &\leq 16 & \\
	2x_1 + 5 x_2 \hspace{8em} +s_2 &\leq 10 & \\ 
	3x_2 + x_3 \hspace{5.5em} +s_3 &\leq 12 & \\
...
\end{flalign*}
\begin{flalign*}
	\text{Max  } z = 24 x_1 + 18 x_2 + 20 x_3 +0s_1 +0s_2 +0s_3 & & \\
	x_1 \hspace{1em}   +x_2 \hspace{1em} +x_3 +s_1 \hspace{5.8em}&\leq 100 &\\ 
	x_1 \hspace{9.5em} +s_2 \hspace{2.8em} &\leq 25 &\\
	x_1 \hspace{1em}   -x_2 \hspace{1em} +x_3 \hspace{5.8em}+s_3&\leq 20 &\\
	x_1, x_2, x_3, s_1, s_2, s_3  &\geq 0 &
\end{flalign*}
...
\end{flalign*}
\begin{flalign*}
	\text{Max  } -z=-2x_1 -9x_2 -4x_3 +0s_1 +0s_2 +MA_1 +MA_2& &\\
	\text{s.t. }\hspace{4em} 2x_1 + 3x_2 + 4x_3 -s_1 \hspace{3.8em} +A_1 \hspace{3.8em} &\geq 12 &\\
	1x_1 + 6x_2 + 2x_3 \hspace{3em} -s_2 \hspace{4.6em} +A_2 &\geq 4 & \\
