...
\begin{parts}
	...
	\end{align*}	
	\includegraphics[width=\linewidth]{"Screen Shot 2022-11-14 at 8.31.13 PM"}
	\includegraphics[width=\linewidth]{"Screen Shot 2022-11-14 at 8.31.30 PM"}
...
\begin{solution}
	\begin{parts}
		...
		The increased capacity of 300 units of steel provides the largest net gain under the current method of production. It is probable that this will allow steel to become the new surplus resource instead of truck capacity.
		
		\part % Q3-D
		0.4906250E+09 - (400)262500
		
		The \$400 dollar decrease is narrowly within the allowable range of decrease on truck profit for this basis to remain optimal. As a result, production should remain the same, but the net export value will be reduced to approximately \$385,625,009.00.
		...
		Steel output will need to have a balance of 10,000. 
		...
		If the new product sells for more than \$750 it will be more profitable to manufacture and sell it rather than exporting the machine units used to produce it. Additionally, this product can take advantage of the surplus manpower. If sold at \$750 the only gain is diversification of production.
