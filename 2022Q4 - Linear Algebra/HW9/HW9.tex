...
\begin{enumerate}[(a)]
	...
	\begin{proof}
		...
		\begin{align*}
			...
			%\intertext{and because \(\mathbf{I}\) is its own adjoint and \(\mathbf{P}\) is assumed to be an orthogonal projection,}
			&= \langle \mathbf{I} \mathbf{u}, \mathbf{v} \rangle - \langle \mathbf{P} \mathbf{u},  \mathbf{v} \rangle \\
		...
		\begin{align*}
			...
			% \intertext{and because \(\mathbf{I}^2 = \mathbf{I}\) and \(\mathbf{P}\) is assumed to be an orthogonal projection,}
