...
Assume that $\mathcal{X}$ is a subspace, it follows $0\in\mathcal{X}$.
\begin{align*}
...
\begin{align*}
	\mathbf{V}(x_1)+\mathbf{V}(x_2) 
	&= \sum_{n\in\mathcal{N}}x_1(n)v_n + \sum_{n\in\mathcal{N}}x_2(n)v_n \\
	&= \sum_{n\in\mathcal{N}}x_1(n)v_n + x_2(n)v_n \\
	&= \sum_{n\in\mathcal{N}}(x_1(n) + x_2(n))v_n \\
	&= \sum_{n\in\mathcal{N}}(x_1+x_2(n))v_n \\
	&= \mathbf{V}(x_1 + x_2)
\end{align*}
...
\begin{align*}
	c\mathbf{V}(x)
	&= \sum_{n\in\mathcal{N}}x(n)v_n \\
	&= \sum_{n\in\mathcal{N}}c(x(n)v_n) \\
	&= \sum_{n\in\mathcal{N}}cx(n)v_n \\
	&= \mathbf{V}(cx)
\end{align*}
