...
First extend the orthogonalized basis from problem 2.

\begin{align*}
	\varrho_3(x)
	&=p_3(x)-\frac{\langle\varrho_0(x),p_3(x)\rangle}{\|\varrho_0(x)\|^2}\varrho_0(x) -\frac{\langle\varrho_1(x),p_3(x)\rangle}{\|\varrho_1(x)\|^2}\varrho_1(x)
	-\frac{\langle\varrho_2(x),p_3(x)\rangle}{\|\varrho_2(x)\|^2}\varrho_2(x) \\
\end{align*}
