...
\begin{enumerate}[(a)]
	...
	\bigskip
	\item
	Let $u\in U_1$ and $v \in U_2$.
	Since $U_1,U_2$ are both subspaces we may see that
	$$u=u+\mathbf{0} \in u+v \in U_1+U_2$$
	and
	$$v=\mathbf{0}+v \in u+v \in U_1+U_2$$.
	Showing that $U_1\cup U_2 \subseteq U_1+U_2$.
	
	\bigskip
	\item
	Let $u_1,u_2\in U_1$ and $v_1,v_2\in U_2$.
	Assuming that 
	$U_1\cup U_2 \subseteq U$
	it follows that
	$(u_1+u_2),(v_1+v_2)\in U$.
	And since $U$ is a subspace
	\begin{align*}
		U_1+U_2&=(u_1+v_1)+(u_2+v_2) \\
		&=u_1+v_1+u_2+v_2\\
		&=u_1+u_2+v_1+v_2\\
		&=(u_1+u_2)+(v_1+v_2)\in U.
	\end{align*}
	Thus if $U_1\cup U_2 \subseteq U$ then $U_1+U_2\subseteq U$.
\end{enumerate}
