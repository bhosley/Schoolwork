...
\begin{frame}{Context for Contribution 1}
    ...
    \begin{multicols}{2}
        ...
        \begin{center}
            \includegraphics[width=0.55\linewidth]{smit2v2.png}
            \includegraphics[width=0.55\linewidth]{smit11v11.png}
        \end{center}
    \end{multicols}
\end{frame}
...
\begin{columns}
    ...
    \begin{column}{0.4\textwidth}
        \begin{figure}
            \includegraphics[width=0.55\textwidth]{waterworld.png}
            \caption{Waterworld environment}
        \end{figure}
        \vspace{-1em}
        \begin{figure}
            \includegraphics[width=0.55\textwidth]{multiwalker.png}
