...
A. Formal Proofs
	•	Full proofs for Section 5 results; counterexample sketches for coherence failure.

B. Environment \& Hyperparameters
	•	Full specs, seeds, ranges; tables for reproducibility.

C. Additional Results
	•	Extended curves, per-seed tables, sensitivity sweeps.
...
%     [yes/partially/no/NA]
%     \item 
%     The number and range of (hyper-) parameter settings explored prior to conducting final experiments have been indicated, along with the effort spent on (hyper-) parameter optimization. 
%     [yes/partially/no/NA]
%     \item 
