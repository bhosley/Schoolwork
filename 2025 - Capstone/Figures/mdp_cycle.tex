\begin{tikzpicture}[>=stealth, node distance=1cm, on grid, auto,
    ...
    \node [] (time) [below left= 0.6cm and 2.3cm of env]{\scriptsize\(\gls{t}:=\gls{t}+1\)};
    ...
    % Labels
    \node [] () [right= 1pt of A] {\(\gls{a}_{\gls{t}}\in\) \Gls{a}};
    \node [] () [left=  1pt of S] {\(\gls{s}_{\gls{t}}\in\) \Gls{s}};
    \node [] () [right= 1pt of R] {\(\gls{r}_{\gls{t}}\in\) \Gls{r}};
\end{tikzpicture}