\begin{tikzpicture}[>=stealth, node distance=3em, on grid, auto,
    ...
    % Agents
    \node (P1) {\includegraphics[width=2em]{drone-sml.pdf}}; 
        \node (P1a) [right= 1.5 of P1] {\(a_{1,t}\in A_1\)};
        \node (P1o) [left= 1.5 of P1, align=center] {\(o_{1,t}\in O_1\) \\ \(r_{1,t}\in R_1\)};
    \node (P2) [below= of P1] {\includegraphics[width=2.5em]{drone-mid.pdf}};
        \node (P2a) [right= 1.5 of P2] {\(a_{2,t}\in A_2\)};
        \node (P2o) [left= 1.5 of P2, align=center] {\(o_{2,t}\in O_2\) \\ \(r_{2,t}\in R_2\)};
    \node (Pn) [below= 1.5 of P2] {\includegraphics[width=3.5em]{drone-lrg.pdf}};
        \node (Pna) [right= 1.5 of Pn] {\(a_{n,t}\in A_n\)};
        \node (Pno) [left= 1.5 of Pn, align=center] {\(o_{n,t}\in O_n\) \\ \(r_{n,t}\in R_n\)};
