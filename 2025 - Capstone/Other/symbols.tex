...
% -------------- General -------------- %
% Number Systems
\glsNewSymbol{field}{\mathbb{F}}{\mathbb{F}}[A field.]
\glsNewSymbol{naturals}{\mathbb{N}}{\mathbb{N}}[The set of all natural numbers.]
\glsNewSymbol{integers}{\mathbb{Z}}{\mathbb{Z}}[The set of all integers.]
\glsNewSymbol{rationals}{\mathbb{Q}}{\mathbb{Q}}[The set of all rational numbers.]
\glsNewSymbol{reals}{\mathbb{R}}{\mathbb{R}}[Set of all real numbers.]
\glsNewSymbol{complex}{\mathbb{C}}{\mathbb{C}}[The set of all complex numbers.]
...
\glsNewSymbol{c}{c}{C}[Channel or obervation element index.]
% Actions
...
\glsNewSymbol{p}{p}{p(\gls{s}^\prime|\gls{s},\gls{a})}[Probability of transitioning to 
    state \(\gls{s}^\prime\) from state \(\gls{s}\) given action \gls{a}.]
% Reward value
...
\glsNewSymbol{step}{\alpha}{\alpha}[Policy update step-size parameter.]
\glsNewSymbol{adv}{A}{A}[Advantage value.]


% -------------- Other -------------- %
% P(S) Powerset
\glsNewSymbol{powerset}{\ensuremath{\mathcal{P}}}{\ensuremath{\mathcal{P}(\mathcal{S})}}[
    Power set; the set of all subsets of set \(\mathcal{S}\).]
% II(a=b) -> 0 or 1 Indicator function
\glsNewSymbol{indicator}{\mathbb{I}}{\mathbb{I}}[
    Indicator function. \(1\) if input is true, \(0\) otherwise.]
