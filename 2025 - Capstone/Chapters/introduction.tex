...
autonomous systems at scale~\cites{robertson2023,zotero-2656}. 
...
\begin{table}[htbp]
\centering
\caption{Mapping of research challenges to dissertation contributions.}
\label{tab:challenge-contribution-map}
\begin{tabular}{@{}l c c c @{}}
\toprule
\textbf{Challenge / Gap} & \textbf{C1} & \textbf{C2} & \textbf{C3} \\
\midrule
Training cost scales poorly with team size 
    & \checkmark &            &            \\
Curriculum approaches untested for heterogeneous teams 
    & \checkmark &            &            \\
Intrinsic heterogeneity prevents parameter sharing 
    &            & \checkmark & \checkmark \\
Explicit indication required for agent differentiation 
    &            & \checkmark &            \\
Permutation sensitivity in centralized critics 
    &            & \checkmark & \checkmark \\
No controlled comparison of invariance paradigms 
    &            &            & \checkmark \\
Robustness to dynamic team compositions 
    &            & \checkmark & \checkmark \\
\bottomrule
\end{tabular}
\end{table}
...
and synthesizes their implications for aspects of \gls{harl} 
system design as indicated by \cref{tab:challenge-contribution-map}.
\Cref{sec:contribution-summary} will revisit this within the 
context provided by the literature review in the next chapter.
