...
Each agent \(\gls{i}\) has access to a subset of these elements determined 
by its sensor configuration \(\Gls{c}_{\gls{i}} \subseteq \Gls{c}\), 
...
\begin{figure}[ht]
    ...
    \label{con3:fig:training_curves}
\end{figure}

\Cref{con3:fig:training_curves} presents the learning curves for Implicit Indication and 
...
\begin{figure*}[ht]
    ...
    \label{con3:fig:eval_comparison}
\end{figure*}

\Cref{con3:fig:eval_comparison} presents the evaluation 
...
\begin{table}[ht]
    ...
    \label{con3:tab:overall_performance}
    \begin{tabular}{lccc}
        \toprule
...
\Cref{con3:tab:overall_performance} summarizes the aggregate performance across all 
...
\begin{figure*}[ht]
    ...
    \label{con3:fig:eval_heatmaps}
\end{figure*}

\Cref{con3:fig:eval_heatmaps} provides a detailed breakdown of performance across 
