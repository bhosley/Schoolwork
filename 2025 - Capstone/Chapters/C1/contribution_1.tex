...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/waterworld.png}
        \caption{Waterworld.}
        \label{con1:fig:waterworld}
    \end{subfigure}
    \hfil
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/multiwalker.png}
        \caption{Multiwalker.}
        \label{con1:fig:multiwalker}
    \end{subfigure}
    \hfil
    \begin{subfigure}{0.3\textwidth}
        \includegraphics[width=\textwidth]{Figures/lbf.png}
...
\]
This is the clipped surrogate objective used in \gls{ppo}, extended here to a multi-agent setting by 
...
\begin{table}[ht]
    ...
    \(\epsilon\) & \gls{ppo} clipping parameter (e.g., 0.2) \\
...
(see \Cref{con1:app:obs_spaces} for detailed examples).
...
\begin{figure}[!ht]
    \centering 
    \input{{Figures/training_1}} % \resizebox{0.85\textwidth}{!}{% % }
    \caption{Example of Training Progression for Waterworld and \gls{lbf}}
    \label{con1:fig:training_1}
\end{figure}
\begin{figure}[!ht]
    \centering
    \input{{Figures/training_2}} % \resizebox{0.85\textwidth}{!}{ }
...
\begin{enumerate}
    ...
    Teams are formed by randomly duplicating the check-pointed policies without regard 
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.875\linewidth]{Figures/iter_cost.png}
    \caption[Training Iteration Timing Across Agent Counts.]{
        \textbf{Training Iteration Timing Across Agent Counts.} Mean wall-clock time 
        per training iteration (in milliseconds) plotted against the number of agents, 
        for each environment. Error bars represent the standard deviation.}
...
% Waterworld figures and AUC analysis
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/Waterworld-4-agent.png}
    \caption[Waterworld Retraining (4 agents, 2-agent pretraining).]{
        \textbf{Waterworld (4 agents, 2-agent pretraining).} 
        Comparison of 4-agent tabula rasa training and retraining trajectories
        using average episodic return over normalized agent-steps.}
    \label{con1:fig:waterworld-4}
\end{figure}

\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/Waterworld-8-agent.png}
    \caption[Waterworld Retraining (8 agents, 2-agent pretraining).]{
        \textbf{Waterworld (8 agents, 2-agent pretraining).} 
        Comparison of 8-agent tabula rasa training and retraining trajectories
        using average episodic return over normalized agent-steps.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/Waterworld-AUCs.png}
    \caption[Waterworld Pretraining Impact.]{
        \textbf{Waterworld Pretraining Impact.} 
        Relative increase in cumulative training returns (AUC) 
        compared to tabula rasa baselines. Rows represent final team sizes, 
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.88\linewidth]{Figures/Multiwalker-5-agent.png}
    \caption[Multiwalker Retraining (5 agents, 3-agent pretraining).]{
        \textbf{Multiwalker (5 agents, 3-agent pretraining).} 
        Comparison of 5-agent tabula rasa training and retraining 
        trajectories using average episodic return over normalized agent-steps.}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.88\linewidth]{Figures/Multiwalker-6-agent.png}
    \caption[Multiwalker Retraining (6 agents, 3-agent pretraining).]{
        \textbf{Multiwalker (6 agents, 3-agent pretraining).}
        Comparison of 6-agent tabula rasa training and retraining trajectories
        using average episodic return over normalized agent-steps.}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/Multiwalker-AUCs.png}
    \caption[Multiwalker Pretraining Impact.]{
        \textbf{Multiwalker Pretraining Impact.} 
        Relative increase in cumulative training returns (AUC) 
        compared to tabula rasa baselines. Rows represent final team sizes, 
        and columns indicate the number of pretraining steps.}
...
\begin{table}[!ht]
    \centering
    \caption[Pairwise $t$-test comparisons between observation schemas.]{
...
(examples are provided in \Cref{con1:app:obs_spaces}).
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/LBF-7-agent.png}
    \caption[Level-Based Foraging Retraining (7 agents, 2-agent pretraining).]{
        \textbf{Level-Based Foraging (7 agents, 2-agent pretraining).} 
        Comparison of 7-agent tabula rasa training and retraining trajectories 
        using average episodic return over normalized agent-steps.}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.9\linewidth]{Figures/LBF-AUCs.png}
    \caption[Level-Based Foraging Pretraining Impact.]{
        \textbf{Level-Based Foraging Pretraining Impact.} Relative increase in 
        cumulative training returns (AUC) compared to tabula rasa baselines. 
...
improve robustness in the face of \emph{emergent heterogeneity}, that is, 
