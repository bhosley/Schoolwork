...
% \end{description}
\begin{align*}
    \Gls{i}& && \text{: Set of all agents} \\
    \Gls{s}& = \{\Gls{s}_{\gls{i}}\}_{\gls{i}\in \Gls{i}} && \text{: Joint state space} \\
    \Gls{o}& = \{\Gls{o}_{\gls{i}}\}_{\gls{i}\in \Gls{i}} && \text{: Joint observation space} \\
    \Gls{a}& = \{\Gls{a}_{\gls{i}}\}_{\gls{i}\in \Gls{i}} && \text{: Joint action space} \\
    \Gls{p}&(\gls{s}^\prime|\gls{s},\gls{a}) && \text{: Transition probability function} \\
    \Gls{r}& = \{\Gls{r}_{\gls{i}}\}_{\gls{i}\in \Gls{i}} && \text{J: oint rewards} \\
    \gls{discount}& && \text{: Reward discount factor.}
\end{align*}
%
