...
\begin{frame}[t]{Common Uses: Unsupervised Learning}
	\begin{columns}
		\column{0.5\textwidth}
		\includegraphics<1>[width=\linewidth]{UnsupClustering}
		\includegraphics<2>[width=\linewidth]{UnsupAssociation}
		\includegraphics<3>[width=\linewidth]{UnsupAnomaly}
	...
	\begin{block}{Remark}
		...
		\only<3>{text}
	\end{block}
	\begin{exampleblock}<2>{Example: Market Basket Analysis}
