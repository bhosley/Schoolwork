{
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        "id": "234Tt4gvgWgj",
        "outputId": "98116097-5fda-4fad-add4-2942c2f00aeb"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "ETp53lSkgWgl",
        "outputId": "264d6870-678a-4b2d-e6ff-a1461dd18bb7"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "ciAfSq56gWgm",
        "outputId": "533f9e37-d584-4899-b568-5b9e007b9515"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "rjo8W5smgWgn",
        "outputId": "cf46d344-0a1e-410c-92eb-643f251344f6"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "943sI8BWgWgp",
        "outputId": "60ec30df-1d99-4385-caba-fa8964328140"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "T5QmZvUrgWgq",
        "outputId": "775db1ff-e311-4456-d1ee-a6eb5e1832c4"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "wyvlDK93gWgs",
        "outputId": "8f93e9de-6556-44a6-edf8-28f79b4fc2c4"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "f3REdQsMgWgt",
        "outputId": "ac3a05ef-147c-48bd-8701-cb50fe6e97a6"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "DQRaUswrgWgv",
        "outputId": "d1e7313c-0174-427e-b085-8e71333e930d"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "XXpi1PL9gWhP",
        "outputId": "589fdcb4-b00d-47d9-c0bb-97cdec6aeafe"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "wzheiSKhgWhQ",
        "outputId": "f2bd1642-3e34-4d38-e440-c127426ce75c"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "htTQETcmgWhR",
        "outputId": "a6c09921-de92-4ef8-8cda-79dd70f8d1eb"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "v_z924OzgWhS",
        "outputId": "ac5e9e4d-d99e-4c2b-c37d-4652e9a5f7df"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "UITIeTdqgWhU",
        "outputId": "49689ae4-7164-4916-dd65-d227b6450b70"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "HCa597JJgWha",
        "outputId": "a0b831db-db65-4aab-b289-205b4074166a"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "scrolled": true,
        "id": "J-6Q9bO5gWhb",
        "outputId": "c853f349-a877-4097-d592-bc505344c28f"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "xjdal5XhgWhc",
        "outputId": "ac159c62-157e-4414-fbb4-a65f9d3bbcd6"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        "id": "Wbsh2ZI6gWhd",
        "outputId": "36210d0b-1dc0-41c0-9e65-f2fba470684f"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        "id": "EpTuwJF0gWhf",
        "outputId": "516bf78f-392b-4a99-ca8c-ff83a6d3073b"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "vKt-GL-GgWhf",
        "outputId": "c4f8c71b-6aa1-41f4-ca5d-3de2df3ad223"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "tP46LyM9gWhh",
        "outputId": "10d16c8f-6cdd-4bed-bde1-85ccd41e1214"
      },
      "outputs": [
        {
          "data": {
            "image/png": "\n",
            "text/plain": [
    ...
    },
    {
      ...
      "metadata": {
        "scrolled": true,
        "id": "FEF7aoqGgWhk",
        "outputId": "5c2ce4f5-b680-4fe6-c470-1f481f265fdd"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        "id": "X0kXLHczgWhk",
        "outputId": "83be3b25-0958-40f9-8830-c2e572b23c3f"
      },
      "outputs": [
        {
          "data": {
            "image/png": "\n",
            "text/plain": [
    ...
    },
    {
      ...
      "metadata": {
        "id": "IJVT_9GmgWhm",
        "outputId": "da281016-1b75-4923-8190-b8c0a49028a6"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        "id": "WOYh6J-HgWhn",
        "outputId": "371e175b-c1d5-44f1-899d-983d9c7a9ac6"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "QImRiJEygWho",
        "outputId": "6906641e-581d-48ad-d5f9-c8df678f85ac"
      },
      "outputs": [
        {
          "data": {
            "image/png": "\n",
            "text/plain": [
              "<Figure size 576x288 with 1 Axes>"
            ]
          },
    ...
    },
    {
      ...
      "metadata": {
        "id": "wTlHjqaugWhp",
        "outputId": "b39f64dd-de4a-48b9-d677-3ab4bc51151c"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        "id": "F-vAsktmgWhp",
        "outputId": "273a77be-1335-4883-fc06-6c35166ace15"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "XAn_0sX3gWhr",
        "outputId": "f738cb6d-24a3-49ef-d0cc-1cc0015c9017"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "fWFtFGR1gWhr",
        "outputId": "07b1a4cf-fa09-4f95-9d2b-def12fcd277e"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "gMtojOuvgWhs",
        "outputId": "e28bef20-cd7d-467e-c986-9226b67fe366"
      },
      "outputs": [
        {
          "data": {
    ...
    },
    {
      ...
      "metadata": {
        "id": "DylpnyplgWhu",
        "outputId": "8d2563e9-d399-4d2a-a4c6-2be1b8c8065c"
      },
      "outputs": [
        {
          "name": "stdout",
    ...
    },
    {
      ...
      "metadata": {
        "id": "SRU6GTDKgWhv",
        "outputId": "bdb4bd26-6f28-4e97-a4de-93d3ad516b23"
      },
      "outputs": [
        {
          "data": {
            "image/png": "\n",
            "text/plain": [
