...
\includepdf[pages=3-]{./Snippets/SAS Output HW5-5.pdf}
\includepdf[pages=3-]{./Snippets/SAS Output HW5-6.pdf}
\includepdf[pages=3-]{./Snippets/SAS Output HW5-7.pdf}
\includepdf[pages=3-]{./Snippets/SAS Output HW5-8.pdf}
