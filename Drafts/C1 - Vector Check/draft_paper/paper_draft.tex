...
could help reduce the practical barriers to deployment. %, particularly for MARL and HARL swarms.
...
% #TODO: CrBC edit:
% I'm a little confused by this 2nd half.  Are these deployments meant to all be bHARL examples?  
%
% In the first half you introduce the notion of iHARL and bHARL.  In the 2nd half you should provide (and label) examples of both types.
...
% #TODO: DrBC edits:
% This comes out of nowhere! introduce the problem, then your solution.

% Introduce the problem:
% Training complexity (e.g., real world clock time) for HARL models depends on both the environment and the team size.  Since our goal is to explore the impacts of varying team sizes on....

% then introduce your solution:
% In order to rectify this issue we establish a novel complexity metric called agent steps.  Which consists of....

% Then justify why your solution is valid:
...
\begin{figure}[!h]
    % #TODO: Increase legend/label font sizes
    \centering
...
\begin{figure}[h]
    \centering
    % #TODO: Decrease decimal precision, increase font size
...
\section{Conclusion}
% #TODO: DrBC edits:
% Expand this a bit.  Keep in mind that the first time someone reads your paper they will read introduction and conclusion and nothing in between.
%
% Thus you need to remind the audience what the overall problem is.  Why that matters, and What you did.   Be succinct .... but not this succinct.
%
