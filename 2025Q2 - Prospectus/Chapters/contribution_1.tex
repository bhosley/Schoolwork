...
\cref{tab:ppo-hyperparams}. For Waterworld and LBF, 
...
\Cref{tab:observation_comparisons} summarizes these comparisons. Across all agent counts, 
...
\Cref{fig:lbf-7} provides an illustrative example, 
