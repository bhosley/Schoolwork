...
Behavioral heterogeneity arises when agents differ not by their 
structure but by the roles they are trained or assigned to perform. 
...
Importantly, agents may share the same observation and action spaces yet 
develop distinct strategies due to their training context. 
...
% Different Algorithms are not necessarily a major component anymore
% #TODO: Change this section to lead into reason for choosing PPO
...
The agents are must coordinate to avoid 
falling or dropping the package. Each agent has a different observation 
space depending on its position (e.g., lead, middle, rear), 
representing a form of static, intrinsic heterogeneity. 
...
% #TODO: ? Add Summary of key challenges
% #TODO: Unify terminology in this section (ex:)
% Lit review sometimes says “scalability,” sometimes “extensibility,” “reuse,” or “efficiency.” 
% Choose a primary term (likely “training efficiency”) and make that consistent throughout.
% #TODO: Unify Terminology across sections?
