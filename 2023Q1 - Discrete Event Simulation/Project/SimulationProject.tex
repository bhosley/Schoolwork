...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/LargeMajority}
	\caption{}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/LessAsymmetricUtility}
	\caption{}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/ThreeGroups}
	\caption{}
	\label{fig:threegroups}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/SixGroups}
	\caption{}
	\label{fig:sixgroups}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/Integrationist}
	\caption{}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/FiveByNeighboorhoods}
	\caption{}
	\label{fig:fivebyneighboorhoods}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/SevenByNeighboorhoods}
	\caption{}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/BinomSym4}
	\caption{}
	\label{fig:binomsym4}
\end{figure}
...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/uniform0to6}
	\caption{}
