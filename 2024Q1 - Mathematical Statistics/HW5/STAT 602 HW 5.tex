...
\begin{questions}
	...
	\begin{solution}
		\begin{parts}
			...
			Starting with example 9.2.1 as an entry point,
			\begin{align*}
				A(\theta) = &\left\{x: \theta_0 - z_{\alpha/2}\sigma/\sqrt{n} < \bar{x} < \theta_0 + z_{\alpha/2}\sigma/\sqrt{n} \right\} \\
				&\left\{x: - z_{\alpha/2}\sigma/\sqrt{n} < \bar{x} - \theta_0 < z_{\alpha/2}\sigma/\sqrt{n} \right\} \\
				&\left\{x: - z_{\alpha/2}\sigma/\sqrt{n} - \bar{x} < - \theta_0 < z_{\alpha/2}\sigma/\sqrt{n} - \bar{x} \right\} \\
				&\left\{x: \bar{x} + z_{\alpha/2}\sigma/\sqrt{n} > \theta_0 > \bar{x} - z_{\alpha/2}\sigma/\sqrt{n} \right\} \\
				C(\bar{x}) = &\left\{x: \bar{x} - z_{\alpha/2}\sigma/\sqrt{n} < \theta_0 < \bar{x} + z_{\alpha/2}\sigma/\sqrt{n} \right\} \\
			\end{align*}
